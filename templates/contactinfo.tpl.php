 ...
 */
?>
<div id="<?php print $id; ?>" class="vcard hola">
    ...
    <?php if ($street_address || $locality || $region || $postal_code || $country): ?>
        <div class="adr">
            <?php if ($street_address): ?>
                <span class="street-address"><span class="glyphicon glyphicon-map-marker"></span><?php print $street_address; ?></span>
            <?php endif; ?>
            <?php if ($extended_address): ?>
                <span class="extended-address"><?php print $extended_address; ?></span>
            <?php endif; ?>
            <?php if ($postal_code): ?>
    ...
    <?php if ($phones || $faxes): ?>
        <div class="phone">
            <?php foreach ($phones as $phone): ?>
                <?php if ($phone): ?>
                    <div class="tel"><span class="glyphicon glyphicon-earphone"></span><a href=""><?php print $phone; ?></a></div>
                <?php endif; ?>
            <?php endforeach; ?>
    ...
    <?php if ($email): ?>
        <span class="glyphicon glyphicon-envelope"></span><a href="<?php print $email_url; ?>" class="email"><?php print $email; ?></a>
    <?php endif; ?>
